        ...
        <Box boxShadow={3} pl={0} pr={0}>
            <Row style={{ background: "white" }} alignItems="center">
                ...
                <Col xs={1} sm={1} md={1} lg={1}>
                    <Box bgcolor="white" pt={"12px"} pb={"12px"} pl={"25px"} color="black">
                        {/* <Link to="/"> */}
                        <h4>Tekonika</h4>
                        {/* </Link> */}
                    </Box>
                ...
                <Col xs={7} sm={7} md={7} lg={7}>
                    <Row justify="space-between">
                        <Col xs={1} sm={1} md={1} lg={1}></Col>
                        <Col xs={1} sm={1} md={1} lg={1}><span className="nav-items">HOME</span></Col>
                        <Col xs={2} sm={2} md={2} lg={2}><span className="nav-items">UI/UX DESIGN</span></Col>
                        <Col xs={3} sm={3} md={3} lg={3}><span className="nav-items">MOBILE APP DEVELOPMENT</span></Col>
                        <Col xs={3} sm={3} md={3} lg={3}><span className="nav-items">WEBSITE DEVELOPMENT</span></Col>
                        <Col xs={1} sm={1} md={1} lg={1}></Col>
                    </Row>
                </Col>
                <Col xs={2} sm={2} md={2} lg={2}>
                    <Row alignItems="center" justify="space-evenly">
                        ...
                        <React.Fragment key={"right"}>
                            <MenuIcon className={classes.menuIcon} onClick={() => setDrawerOpen(true)} />
                            <Drawer transitionDuration={800} anchor={"right"} open={drawerOpen} onClose={():void => setDrawerOpen(false)}>
                                {list}
                            </Drawer>
                        </React.Fragment>
                    </Row>
