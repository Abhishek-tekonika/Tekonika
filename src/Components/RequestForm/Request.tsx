...
const Request = (): JSX.Element => {
    ...
    return(
        ...
        <Container style={{marginTop:"100px"}}>
            ...
            <Row> 
                <Col xs lg="6">
                  <h3 className="txt1">Start a project with Tekonika today, it’s easier than ever before.</h3>
                </Col>
            </Row>
        </Container>
        <Container>
    ...
    <Col xs={6} md={4}>
       <div className="timeline">
           <ul>
            ...
            <p>Complete the application form below to tell us about your project.
            Ensure you signed the NDA and upload necessary documents.
            </p>
                   </div>
               </li>
               <li>
                   ...
                   <h2 style={{marginTop:"50px"}}>Meeting Schedule</h2>
                    <p>You will receive an email with details on how you
                    can schedule a virtual meeting with our team to discuss your project requirement.
                    </p>
                   </div>
               </li>
               <li>
                   ...
                   <h2 style={{marginTop:"50px"}}>Receive a Quotation</h2>
                        <p>After the meeting, we will send you your project development quotation. 
                        You need to approve our quotation for us to proceed.
                        </p>
                   </div>
               </li>
           </ul>
    ...
    <span className="error">{errors.budget && errors.budget.message}</span>
        ...
        <div className="form-group">
        <label htmlFor="description">Elaborate on your request*</label>
